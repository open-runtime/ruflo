 ...
 *
 * Usage:
 *   ruflo ruvector setup              # Output to ./ruvector-postgres/
 *   ruflo ruvector setup --output /path/to/dir
 *   ruflo ruvector setup --print      # Print to stdout only
 *
...
ruflo memory list --format json > memory-export.json
