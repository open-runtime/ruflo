...
# With namespace
ruflo sparc run supabase-admin "your task" --namespace supabase-admin

# Non-interactive mode
ruflo sparc run supabase-admin "your task" --non-interactive
```
...
```bash
# Store mode-specific context
ruflo memory store "supabase-admin_context" "important decisions" --namespace supabase-admin

# Query previous work
ruflo memory query "supabase-admin" --limit 5
```
