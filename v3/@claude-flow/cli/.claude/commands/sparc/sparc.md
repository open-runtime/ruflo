...
ruflo sparc run sparc "orchestrate authentication system"

# For alpha features
ruflo sparc run sparc "orchestrate authentication system"

# With namespace
ruflo sparc run sparc "your task" --namespace sparc

# Non-interactive mode
ruflo sparc run sparc "your task" --non-interactive
```
...
```bash
# Store mode-specific context
ruflo memory store "sparc_context" "important decisions" --namespace sparc

# Query previous work
ruflo memory query "sparc" --limit 5
```
