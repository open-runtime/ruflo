...
```bash
ruflo hook pre-edit -f "config/database.js" --validate-syntax
```

### Manual agent assignment

```bash
ruflo hook pre-edit -f "api/users.ts" --auto-assign-agent false
```
...
ruflo hook pre-edit --file "path/to/file.js" --validate-syntax
```
