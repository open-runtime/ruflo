...
```bash
ruflo agent logs <agent-id> [options]
```
...
```bash
# View last 50 lines
ruflo agent logs coder-lx7m9k2

# View last 100 lines
ruflo agent logs coder-lx7m9k2 -n 100

# Follow logs (live)
ruflo agent logs coder-lx7m9k2 --follow

# Filter by level
ruflo agent logs coder-lx7m9k2 -l error

# Logs since time
ruflo agent logs coder-lx7m9k2 --since "1h"
ruflo agent logs coder-lx7m9k2 --since "2026-01-08T10:00:00"

# JSON output
ruflo agent logs coder-lx7m9k2 --format json
```
...
# Last 30 minutes
ruflo agent logs coder-lx7m9k2 --since "30m"

# Specific timestamp
ruflo agent logs coder-lx7m9k2 --since "2026-01-08T09:00:00"

# Today's logs
ruflo agent logs coder-lx7m9k2 --since "today"
```
...
- `ruflo agent status` - Current agent status
- `ruflo agent health` - Health monitoring
