...
ruflo topology-analyze --swarm-id <id> --metrics performance

# Optimize topology automatically
ruflo topology-optimize --swarm-id <id> --strategy adaptive

# Compare topology configurations
ruflo topology-compare --topologies ["hierarchical", "mesh", "hybrid"]

# Generate topology recommendations
ruflo topology-recommend --workload-profile <file> --constraints <file>

# Monitor topology performance
ruflo topology-monitor --swarm-id <id> --interval 60
```

### Agent Placement Commands
```bash
# Optimize agent placement
ruflo placement-optimize --algorithm genetic --agents <agent-list>

# Analyze placement efficiency
ruflo placement-analyze --current-placement <config>

# Generate placement recommendations
ruflo placement-recommend --communication-patterns <file>
```
