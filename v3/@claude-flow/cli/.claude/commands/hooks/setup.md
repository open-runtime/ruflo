...
```bash
# Test pre-edit hook
ruflo hook pre-edit --file test.js

# Test session summary
ruflo hook session-end --summary
```
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [{
          "type": "command",
          "command": "ruflo hook pre-write --file '${tool.params.file_path}'"
        }]
      }
    ]
  }
...
# Test specific hook
ruflo hook pre-edit --file app.js --debug
```
