...
ruflo sparc run post-deployment-monitoring-mode "monitor production metrics"

# For alpha features
ruflo sparc run post-deployment-monitoring-mode "monitor production metrics"

# With namespace
ruflo sparc run post-deployment-monitoring-mode "your task" --namespace post-deployment-monitoring-mode

# Non-interactive mode
ruflo sparc run post-deployment-monitoring-mode "your task" --non-interactive
```
...
```bash
# Store mode-specific context
ruflo memory store "post-deployment-monitoring-mode_context" "important decisions" --namespace post-deployment-monitoring-mode

# Query previous work
ruflo memory query "post-deployment-monitoring-mode" --limit 5
```
