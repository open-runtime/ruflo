...
ruflo sparc run tutorial "guide me through SPARC methodology"

# For alpha features
ruflo sparc run tutorial "guide me through SPARC methodology"

# With namespace
ruflo sparc run tutorial "your task" --namespace tutorial

# Non-interactive mode
ruflo sparc run tutorial "your task" --non-interactive
```
...
```bash
# Store mode-specific context
ruflo memory store "tutorial_context" "important decisions" --namespace tutorial

# Query previous work
ruflo memory query "tutorial" --limit 5
```
