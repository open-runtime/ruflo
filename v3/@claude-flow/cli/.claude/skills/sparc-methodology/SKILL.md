...
ruflo sparc tdd "feature description"

# Batch execution
ruflo sparc batch <mode1,mode2,mode3> "task"

# Pipeline execution
ruflo sparc pipeline "task description"
```
...
ruflo sparc run researcher "authentication patterns"

# Step 2: Architecture design
ruflo sparc run architect "design auth system"

# Step 3: TDD implementation
ruflo sparc tdd "user authentication feature"

# Step 4: Code review
ruflo sparc run reviewer "review auth implementation"

# Step 5: Documentation
ruflo sparc run documenter "document auth API"
```
...
ruflo sparc run analyzer "investigate bug #456"

# Step 2: Debug systematically
ruflo sparc run debugger "fix memory leak in service X"

# Step 3: Create tests
ruflo sparc run tester "regression tests for bug #456"

# Step 4: Review fix
ruflo sparc run reviewer "validate bug fix"
```
...
ruflo sparc run analyzer "profile API response times"

# Step 2: Identify bottlenecks
ruflo sparc run optimizer "optimize database queries"

# Step 3: Implement improvements
ruflo sparc run coder "implement caching layer"

# Step 4: Benchmark results
ruflo sparc run tester "performance benchmarks"
```
...
ruflo sparc pipeline "e-commerce checkout feature"
