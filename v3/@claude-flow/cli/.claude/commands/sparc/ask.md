...
# With namespace
ruflo sparc run ask "your task" --namespace ask

# Non-interactive mode
ruflo sparc run ask "your task" --non-interactive
```
...
```bash
# Store mode-specific context
ruflo memory store "ask_context" "important decisions" --namespace ask

# Query previous work
ruflo memory query "ask" --limit 5
```
