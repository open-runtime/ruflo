...
# With namespace
ruflo sparc run integration "your task" --namespace integration

# Non-interactive mode
ruflo sparc run integration "your task" --non-interactive
```
...
```bash
# Store mode-specific context
ruflo memory store "integration_context" "important decisions" --namespace integration

# Query previous work
ruflo memory query "integration" --limit 5
```
