...
# With namespace
ruflo sparc run docs-writer "your task" --namespace docs-writer

# Non-interactive mode
ruflo sparc run docs-writer "your task" --non-interactive
```
...
```bash
# Store mode-specific context
ruflo memory store "docs-writer_context" "important decisions" --namespace docs-writer

# Query previous work
ruflo memory query "docs-writer" --limit 5
```
