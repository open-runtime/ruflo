...
const daemonCommand: Command = {
  ...
  options: [
    ...
    },
    {
      ...
      default: displayProjectRuntimePath('daemon.pid'),
    },
    {
      name: 'log-file',
      type: 'string',
      description: 'Log file location',
      default: displayProjectRuntimePath('daemon.log'),
    },
    {
      name: 'detach',
      type: 'boolean',
  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    const pidFile = (ctx.flags?.['pid-file'] as string) || displayProjectRuntimePath('daemon.pid');
    const logFile = (ctx.flags?.['log-file'] as string) || displayProjectRuntimePath('daemon.log');
