...
ruflo sparc run spec-pseudocode "define payment flow requirements"

# For alpha features
ruflo sparc run spec-pseudocode "define payment flow requirements"

# With namespace
ruflo sparc run spec-pseudocode "your task" --namespace spec-pseudocode

# Non-interactive mode
ruflo sparc run spec-pseudocode "your task" --non-interactive
```
...
```bash
# Store mode-specific context
ruflo memory store "spec-pseudocode_context" "important decisions" --namespace spec-pseudocode

# Query previous work
ruflo memory query "spec-pseudocode" --limit 5
```
