...
export const completionsCommand: Command = {
  ...
  options: [],
  examples: [
    { command: 'ruflo completions bash > ~/.bash_completion.d/claude-flow', description: 'Install bash completions' },
    { command: 'ruflo completions zsh > ~/.zfunc/_claude-flow', description: 'Install zsh completions' },
    { command: 'ruflo completions fish > ~/.config/fish/completions/claude-flow.fish', description: 'Install fish completions' },
  ...
  action: async (): Promise<CommandResult> => {
    ...
    output.writeln(output.dim('  ruflo completions bash > ~/.bash_completion.d/claude-flow'));
    ...
    output.writeln(output.dim('  ruflo completions zsh > ~/.zfunc/_claude-flow'));
    output.writeln(output.dim('  # Add to ~/.zshrc: fpath=(~/.zfunc $fpath); autoload -Uz compinit && compinit'));
    output.writeln();
    output.writeln(output.bold('Fish:'));
    output.writeln(output.dim('  ruflo completions fish > ~/.config/fish/completions/claude-flow.fish'));
    output.writeln();
