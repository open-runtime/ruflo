...
# With namespace
ruflo sparc run code "your task" --namespace code

# Non-interactive mode
ruflo sparc run code "your task" --non-interactive
```
...
```bash
# Store mode-specific context
ruflo memory store "code_context" "important decisions" --namespace code

# Query previous work
ruflo memory query "code" --limit 5
```
